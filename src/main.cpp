...
int main() {
	...
	Shader shader("resources/shaders/modelLoading/modelLoading.vert", "resources/shaders/modelLoading/modelLoading.frag");

	// Load models
	Model ourModel("resources/models/sonic/Sonic.obj");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// SpotLight
		glUniform3f(glGetUniformLocation(shader.getProgram(), "spotLight.position"), camera.getPosition().x,
					camera.getPosition().y, camera.getPosition().z);
		glUniform3f(glGetUniformLocation(shader.getProgram(), "spotLight.direction"), camera.getFront().x,
					camera.getFront().y, camera.getFront().z);
		glUniform3f(glGetUniformLocation(shader.getProgram(), "spotLight.ambient"), 0.05f, 0.05f, 0.05f);
		...
		glUniform1f(glGetUniformLocation(shader.getProgram(), "spotLight.outerCutOff"), glm::cos(glm::radians(25.0f)));
		...
		glm::mat4 model;
		model = glm::translate(model, glm::vec3(0.0f, -1.5f,
